...
public class IngresoDB extends SQLiteOpenHelper {
    ...
    public IngresoDB(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
